...
--exp_dir=css/experiment/swim_unetr/$(date +%m_%d)_Ab_norm_clip_processed_data \
--fig_save_path=$(date +%m_%d)_Ab_norm_clip_processed_data.png \
--transforms=my_tr_trs > css/$(date +%m_%d)_Ab_norm_clip_processed_data.log 2>&1 &
