...
from css.swin_unetr_css_merging_skipV4_imageconvInSkip_add import SwinUNETR as SwinUNETR_css_merging_imageconvInSkip_add
from css.swin_unetr_css_merging_skipV4_imageconvMerging_add import SwinUNETR as SwinUNETR_css_merging_skipV4_imageconvMerging_add
import torch
import os
import json
def css_model(args):
    ...
    elif args.model == 'SwinUNETR_css_merging_imageconvInSkip_add':
        print("Using SwinUNETR_css_merging_imageconvInSkip_add!")
        # ******************************************Create Swin UNETR model*******************************************
    ...
    elif args.model == 'SwinUNETR_css_merging_skipV4_imageconvMerging_add':
        print("Using SwinUNETR_css_merging_skipV4_imageconvMerging_add!")
        # ******************************************Create Swin UNETR model*******************************************
